...
#
# ===-----------------------------------------------------------------------===#
# source: https://clang.llvm.org/extra/doxygen/run-clang-tidy_8py_source.html
# For vesal devs: This is an outside script, not a part of the vesal project. 
# Should run check-clang-tidy.py at root path instead. 
# Don't modify this file, nor run this file along.
